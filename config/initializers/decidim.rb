...
Decidim.configure do |config|
  ...
  config.application_name = "participer.valdemarne.fr"
  config.mailer_sender = "participer.valdemarne.fr <ne-pas-repondre@opensourcepolitics.eu>"
  # config.mailer_sender = "participer.valdemarne.fr <participer@valdemarne.fr>"
