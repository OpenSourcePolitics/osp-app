...
# require File.expand_path('../../../app/forms/decidim/proposals/proposal_form.rb', Decidim::Proposals::Engine.called_from)

# Overrides for decidim-proposals/app/forms/decidim/proposals/proposal_form.rb
module Decidim
  module Proposals
    ...
    class ProposalForm < Decidim::Form
      ...
      validates :body, length: { maximum: 6000 }, etiquette: true
