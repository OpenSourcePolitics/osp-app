...
ActiveRecord::Schema.define(version: 2019_10_07_154819) do
  ...
  create_table "decidim_organizations", id: :serial, force: :cascade do |t|
    ...
    t.string "unique_identity_methods", default: ["online"], array: true
    t.jsonb "unique_identity_explanation_text", default: {}
