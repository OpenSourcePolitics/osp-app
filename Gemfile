...
gem "decidim", git: "https://github.com/decidim/decidim.git", branch: "release/0.21-stable"
...
group :development, :test do
  ...
  gem "decidim-dev", git: "https://github.com/decidim/decidim.git", branch: "release/0.21-stable"
