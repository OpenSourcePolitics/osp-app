...
gem "decidim", git: "https://github.com/OpenSourcePolitics/decidim.git", branch: "alt/mel-0.16"
...
group :development, :test do
  ...
  gem "decidim-dev", git: "https://github.com/OpenSourcePolitics/decidim.git", branch: "alt/mel-0.16"
