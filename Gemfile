...
gem "decidim", git: "https://github.com/OpenSourcePolitics/decidim.git", branch: "0.11-stable-no-moderation"
...
group :development, :test do
  ...
  gem "decidim-dev", git: "https://github.com/OpenSourcePolitics/decidim.git", branch: "0.11-stable-no-moderation"
end
