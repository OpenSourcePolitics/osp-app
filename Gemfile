...
gem "decidim", git: "https://github.com/OpenSourcePolitics/decidim.git", branch: "fix/factories"
...
group :development, :test do
  ...
  gem "decidim-dev", git: "https://github.com/OpenSourcePolitics/decidim.git", branch: "fix/factories"
