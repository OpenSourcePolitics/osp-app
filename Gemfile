...
gem "decidim", git: "https://github.com/OpenSourcePolitics/decidim.git", branch: "0.11-angers-budget"
...
group :development, :test do
  ...
  gem "decidim-dev", git: "https://github.com/OpenSourcePolitics/decidim.git", branch: "0.11-angers-budget"
end
